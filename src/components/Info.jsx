    ...
    <div className="mt-20  flex justify-center mx-20">
      ...
      >
        <div className="flex flex-col justify-center items-center space-y-8">
          <h3 className="text-4xl font-nunito font-black leading-9 text-customGrayText">
            Over Six Decades of Laboratory Knowledge
          </h3>
          <p className="font-nunito text-customGrayText py-2 px-64 text-center text-lg ">
            Established in 1959, Agaram has been a part of the laboratory space
            for the last 6 decades. Our team has over 25 years of experience in
            the design & development of laboratory informatics solutions.
          </p>
          <img src="../client-img.png" alt="" className="w-8/12 h-auto" />
